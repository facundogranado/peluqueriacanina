...
public class Cliente implements Serializable {
    ...
    public Cliente(String nombre_perro, String raza, String color, Boolean alergico, Boolean atencion_especial, String nombre_duenio, String cel_duenio, String observaciones) {
        this.nombre_perro = nombre_perro;
        this.raza = raza;
        this.color = color;
        this.alergico = alergico;
    ...
    public String toString() {
        return "Cliente{" + "num_cliente=" + num_cliente + ", nombre_perro=" + nombre_perro + ", raza=" + raza + ", color=" + color + ", alergico=" + alergico + ", atencion_especial=" + atencion_especial + ", nombre_duenio=" + nombre_duenio + ", cel_duenio=" + cel_duenio + ", observaciones=" + observaciones + '}';
    }
